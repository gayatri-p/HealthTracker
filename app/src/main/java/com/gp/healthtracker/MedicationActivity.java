...
public class MedicationActivity extends AppCompatActivity {
    ...
    String TABLE_CATEGORY = "medication";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Medication Timings");

        // initialize variables
        emptyView = findViewById(R.id.empty_view_medication);
        ...
        mAdapter = new ActivityAdapter(MedicationActivity.this, MedicationActivity.this, arrayListIds, arrayListTimes, arrayListNotes, arrayListIsDones, TABLE_CATEGORY);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MedicationActivity.this, AddActivity.class);
