...
public class ReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Reading Times");

        // initialize variables
        emptyView = findViewById(R.id.empty_view_read);
        recyclerView = findViewById(R.id.recyclerView_read);
        ...
        mAdapter = new ActivityAdapter(ReadActivity.this, ReadActivity.this, arrayListIds, arrayListTimes, arrayListNotes, arrayListIsDones, TABLE_CATEGORY);
