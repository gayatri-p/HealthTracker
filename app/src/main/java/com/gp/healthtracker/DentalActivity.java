...
public class DentalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Dental Health");

        // initialize variables
        emptyView = findViewById(R.id.empty_view_dental);
        ...
        mAdapter = new ActivityAdapter(DentalActivity.this, DentalActivity.this, arrayListIds, arrayListTimes, arrayListNotes, arrayListIsDones, TABLE_CATEGORY);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DentalActivity.this, AddActivity.class);
