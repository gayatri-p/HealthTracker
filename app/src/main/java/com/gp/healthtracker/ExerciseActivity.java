...
public class ExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Exercise Timings");

        // initialize variables
        emptyView = findViewById(R.id.empty_view_exercise);
        recyclerView = findViewById(R.id.recyclerView_exercise);
        ...
        mAdapter = new ActivityAdapter(ExerciseActivity.this, ExerciseActivity.this, arrayListIds, arrayListTimes, arrayListNotes, arrayListIsDones, TABLE_CATEGORY);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExerciseActivity.this, AddActivity.class);
